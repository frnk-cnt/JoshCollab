...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 425.5, 34.0, 128.0, 128.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 325.0, 82.0, 20.0 ],
					"text" : "range 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.5, 325.0, 82.0, 20.0 ],
					"text" : "range 0.1 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.0, 390.0, 139.0, 22.0 ],
					"text" : "Prepend knob7_revTime"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 239.0, 359.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 390.0, 148.0, 22.0 ],
					"text" : "prepend knob8_revMix"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 15.0, 34.0, 225.0, 105.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 89.0, 353.0, 50.0, 23.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 862.5, 1420.0, 40.0, 23.0 ],
									"text" : "mix"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 435.0, 1420.0, 40.0, 23.0 ],
									"text" : "mix"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 895.5, 1356.0, 60.0, 21.0 ],
									"text" : "Dry mix"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 544.5, 1356.0, 207.0, 23.0 ],
									"text" : "param knob8_revMix @min 0 @max 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 345.0, 1365.0, 30.0, 23.0 ],
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1335.0, 735.0, 115.0, 37.0 ],
									"text" : "param early 1 @min 0 @max 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 945.0, 1487.0, 38.0, 23.0 ],
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 435.0, 1487.0, 38.0, 23.0 ],
									"text" : "out 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "param tail 0.5 @min 0 @max 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1125.0, 253.0, 177.0, 23.0 ],
									"text" : "param knob7_revTime @min 0.1"
								}
...
,
					...
					"saved_object_attributes" : 					{
						"exportfolder" : "Macintosh HD:/Users/joshuacook/working/JoshCollab/Rev/",
						"exportname" : "revDaisy_2d0"
					}
,
					"text" : "gen~",
					"varname" : "revDaisy_2d0"
				}
